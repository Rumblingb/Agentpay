...
<p class="sub">AgentPay Labs · payment authority for agents · Last updated 6 September 2026</p>

<div class="card"><strong>The short version:</strong> AgentPay is guardrails and payment authority for agents — one key, a spend limit, card or crypto. We use only the information needed to issue that key, enforce the limit, and produce a receipt. We do not sell personal information.</div>

<h2>Information we process</h2>
<p>When you register or use AgentPay we may process the merchant name and email you provide, a hashed API key, optional funding details needed to complete a payment you approve, spend-limit and mandate records, receipts, and operational logs used for security and reliability.</p>

<h2>How we use information</h2>
<p>We use this information to create and authenticate your merchant key, apply the spend limit you set, settle card or crypto payments you authorize, send service email such as a one-time API key, maintain security, diagnose failures, and comply with applicable law.</p>

<h2>Storage and retention</h2>
<p>API keys are stored as hashes. We retain merchant account data and payment audit records for as long as the account is active and as required for receipts, chargebacks, and legal obligations. You can request deletion using the address below; regulatory-hold data may be retained where the law requires it.</p>

<h2>Service providers and disclosure</h2>
<p>We share information only with infrastructure and payment processors needed to operate the service, or when required by law. We do not sell personal information or use it for advertising.</p>
...
<h2>Your control</h2>
<p>You can rotate or recover an API key, and you can request access, correction, or deletion of information associated with the service using the address below.</p>
...
<hr>
<p class="foot">© 2026 AgentPay Labs. <a href="https://agentpay.so">AgentPay</a> · <a href="/terms">Terms of Service</a></p>
</div></body></html>`;
...
<body><div class="wrap"><h1>AgentPay Terms of Service</h1><p class="sub">AgentPay Labs · payment authority for agents · Last updated 6 September 2026</p><div class="card">By using AgentPay you agree to use the service as payment authority for agents you control: one key, a spend limit you set, and settlement by card or crypto.</div>
<h2>Authorized use</h2><p>You must comply with applicable law. You may not use the service for unauthorized access, fraud, spam, impersonation, or payments you are not authorized to make. You are responsible for agents that spend under your key and for the limit you set.</p>
<h2>Payment authority</h2><p>AgentPay does not take custody of your funds. Card and crypto settlement is handled by the payment rails you use. You review and approve spend that sits outside the limit you configured.</p>
<h2>Availability</h2><p>The service is provided as available. Payment processors, rate limits, and outages may delay or prevent actions. We may suspend unsafe or unauthorized use.</p>
<h2>Contact</h2><p>Questions: <a href="mailto:rajiv_baskaran@agentpay.so">rajiv_baskaran@agentpay.so</a>.</p><p><a href="/">AgentPay</a> · <a href="/privacy">Privacy Policy</a></p></div></body></html>`;
