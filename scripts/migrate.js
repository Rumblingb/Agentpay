...
const migrations = [
  ...
  // ── 036 Governed execution approvals ───────────────────────────────────
  // Binds biometric/device confirmation to the exact server-created action
  // payload and makes execution claims one-time and replay-safe.
  {
    name: '036_execution_approvals',
    sql: `
