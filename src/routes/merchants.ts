 ...
 *
 * Creates a Stripe Connect account link for the authenticated merchant.
 * Returns the onboarding URL that the merchant should redirect to in order
 * to complete Stripe Connect setup (enables fiat payments via AgentPay).
 */
