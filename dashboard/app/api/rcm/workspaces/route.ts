...
export async function POST(req: NextRequest) {
  ...
  for (const key of ['practiceName', 'name', 'specialty', 'workspaceType', 'mainPayer', 'mainProblem', 'npi'] as const) {
    if (body[key] !== undefined && body[key] !== null && (typeof body[key] !== 'string' || (body[key] as string).length > 240)) {
