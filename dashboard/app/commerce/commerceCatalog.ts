...
export const PRODUCTS: Product[] = [
  {
    id: 'tidepack-commuter', name: 'Tidepack Commuter', maker: 'Recycled waterproof shell', merchant: 'Northline Goods',
  ...
  {
    id: 'hush-45', name: 'Hush 45', maker: 'Adaptive over-ear headphones', merchant: 'Aster Audio',
  ...
  {
    id: 'mossline-shell', name: 'Mossline Shell', maker: 'Recycled three-layer weave', merchant: 'Field & Form',
  ...
  {
    id: 'beam-mini', name: 'Beam Mini', maker: 'Warm dimmable task light', merchant: 'Common Object',
  ...
  {
    id: 'stack-system', name: 'Stack System', maker: 'Modular recycled composite', merchant: 'Room Made',
  ...
  {
    id: 'dawn-halo', name: 'Dawn Halo', maker: 'Low-glare sunrise light', merchant: 'Good Morning Co.',
